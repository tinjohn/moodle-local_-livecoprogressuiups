...
function local_livecoprogressuiups_navigationlinks(moodle_page $page, context $context) {
    
}

//\local_livecoprogressuiups\livecoprogressuiups::add_js_dynamics();
//\local_livecoprogressuiups\renderer::addlistener();

function local_livecoprogressuiups_extend_settings_navigation($settingsnav, $context) {
    // global $PAGE;
